...
public class ChatClientImplReceive extends UnicastRemoteObject implements ChatClient {
	private String nombreCliente;
	private ClientGUIReceive interfaz;
	private Receive cliente;
	private PrivateGUIReceive interfazPrivate;
	private ChatClient ch; 
	
	protected ChatClientImplReceive(ClientGUIReceive interfaz,Receive cliente) throws RemoteException {
		super(0);
	...
	public void conectarClientes(String nombreUsuario, String nick, String URL) {
		...
		try {
			...
			interfazPrivate = new PrivateGUIReceive(cliente);
